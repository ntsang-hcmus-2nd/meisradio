      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 w-[600px] shadow-2xl">
        ...
        <div className="flex gap-6">
          <div className="w-1/3 flex flex-col gap-3 items-center">
            ...
            <button onClick={onSelectImage} className="text-xs text-emerald-400 hover:text-emerald-300 bg-emerald-500/10 px-3 py-1.5 rounded-md">Đổi ảnh bìa</button>
          </div>
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button onClick={onSave} className="bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-2 rounded-lg font-medium">Lưu thay đổi</button>
        </div>
      </div>
    </div>
  )
