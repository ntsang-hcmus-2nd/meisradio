  ...
  return (
    <div className="relative w-full">
      <select
        ...
        className="w-full appearance-none bg-zinc-900 text-zinc-200 text-xs border border-zinc-700/80 rounded-lg px-3 py-2 pr-8 cursor-pointer focus:outline-none focus:border-theme-10 transition-colors"
      >
        {options.map((opt) => (
